...
def get_dirs_for_plot_trajectories(
    ...
    def get_input_dir_for_config(config: str) -> str:
        return f"/Users/ameyad/Documents/google-research/workdirs/performance_vs_samples/action_angle_networks/configs/harmonic_motion/{config}/k_pair=0.5/num_samples=200"
...
def get_dirs_for_plot_inference_times(
    ...
    def get_input_dir_for_config(config: str) -> str:
        return f"/Users/ameyad/Documents/google-research/workdirs/performance_vs_samples/action_angle_networks/configs/harmonic_motion/{config}/k_pair=0.5/num_samples=100"
